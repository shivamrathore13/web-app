...
firebase.initializeApp({
  apiKey: "AIzaSyC9MYs1kRHZiZdeU4CRP6OsReupTn0Da-4",
  authDomain: "webapp-e6fd2.firebaseapp.com",
  databaseURL: "https://webapp-e6fd2-default-rtdb.firebaseio.com",
  projectId: "webapp-e6fd2",
  storageBucket: "webapp-e6fd2.appspot.com",
  messagingSenderId: "302306959707",
  appId: "1:302306959707:web:7cabe5090e01c42edf3a7e"
});
      ...
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          ...
          <p className="mb-8 text-lg text-center">
            Connect with your team in new way.
          </p>
          <button
